...
pub enum Expression<T> {
    ...
    Slice(Box<Expression<T>>, Option<Box<Expression<T>>>, Option<Box<Expression<T>>>, Option<Box<Expression<T>>>, Range<usize>),
...
impl Expression<Type> {
    pub fn t(&self) -> Type {
        match self {
            ...
            Expression::Slice(_, _, _, _, _) => Type::PDF,
    ...
    pub fn range(&self) -> &Range<usize> {
        match self {
            ...
            Expression::Slice(_, _, _, _, range) => range,
